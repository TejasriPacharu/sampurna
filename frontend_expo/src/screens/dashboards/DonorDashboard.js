    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.sectionHeader}>
          <Text style={[styles.dashboardTitle, { color: ACCENT }]}>Donor Dashboard</Text>
          <Text style={styles.dashboardSubtitle}>Manage your food surplus listings</Text>
        </View>

        {/* Stats */}
        <View style={styles.statsRow}>
          {[
            { label: 'Listings',    value: '0', icon: '📋' },
            { label: 'Meals Saved', value: '0', icon: '🍱' },
        ...
        {[
          { icon: '➕', label: 'Add Food Listing',  sublabel: 'Post surplus food for pickup' },
          { icon: '📦', label: 'Active Listings',   sublabel: 'View and manage your posts'   },
          { icon: '📊', label: 'Impact Report',     sublabel: 'See your contribution stats'  },
        ].map((action) => (
